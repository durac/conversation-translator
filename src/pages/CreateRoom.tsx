...
const CreateRoom: React.FC = () => {
  ...
  useEffect(() => {
    register('language', { required: t('create.errors.languageRequired') });
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      setError(error instanceof Error ? error.message : t('create.errors.createFailed'));
    }
  };
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  {...register('userName', { required: t('create.errors.nameRequired') })}
                />
                {errors.userName && (
              ...
              <div>
                ...
                <LanguageSelector
                  ...
                  placeholder={t('create.selectLanguage')}
                />
                {errors.language && (
